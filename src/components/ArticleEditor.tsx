...
export default function ArticleEditor({ article, category, isAdmin }: ArticleEditorProps) {
  ...
  return (
    <article className="container mx-auto px-4 py-12 md:px-6 max-w-4xl min-h-screen">
      ...
      <div className="prose prose-lg prose-zinc max-w-none w-full break-all break-words prose-headings:font-black prose-headings:tracking-tighter prose-headings:italic prose-p:leading-relaxed prose-img:rounded-[2.5rem] prose-img:shadow-2xl prose-img:mx-auto">
        {isEditing ? (
